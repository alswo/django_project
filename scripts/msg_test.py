    ...
    for p in prop:
        ...
        for f in fcm:
            ...
            if pushcheck == False:
                ...
                if types == 'android':
                    payload = '{\n    "to" : "' + str(token) + '","priority" : "high", "content-available" : "true","collapse_key" : "Updates Available" ,"notification": {\t  "body" : "'+msg+'","title" : "shuttle tayo", "sound":"default", "color":"#0066ff"},\t}'
                elif types == 'ios':
                    payload = '{\n    "to" : "' + str(token) + '","priority" : "high", "content-available" : "true","collapse_key" : "Updates Available" ,"notification": {\t  "body" : "'+msg+'", "sound":"default", "color":"#0066ff"},\t}'
                try:
