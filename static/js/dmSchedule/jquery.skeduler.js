  ...
  */
  ...
  function appendTasks(placeholder, tasks) {
    ...
    tasks.forEach(function (task, index) {
      ...
      else if(2 < snum && snum <= 4){
          color = "RGB(186, 237, 145)";
      }
      else if(4 < snum && snum <= 6){
          color = "RGB(250, 248, 132)";
      }
      else if(6 < snum && snum <= 8){
          color = 'RGB(248, 184, 139)';
      }
      else if(8 < snum && snum <= 10){
          color = "RGB(254, 163, 170)";
      }        
      else{
          color = "#F70000";
      }
      ...
      var card = $('<div></div>')
        .attr({
          style: 'background-color: ' + color +';'+'top: ' + top + 'px; height: ' + (height - 4) + 'px; ' + 'width: ' + (width - 8) + 'px; left: ' + left + 'px',
