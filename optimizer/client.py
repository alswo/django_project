...
import requests  
import json
algorithm = ['prim', 'salesman', 'onlytime']
params = {}
...
data = {'startName': 'A', 'startX':'14148317.661607', 'startY':'4494878.084352', 'endName':'B', 'endX':'14148219.329390', 'endY':'4494726.671574', 'viaPoints': [{ 'viaPointName':'C', 'index':1, 'viaPointX':'14148809.322692', 'viaPointY':'4493197.096773'}, {'viaPointName':'D', 'index':0, 'viaPointX':'14147628.099206', 'viaPointY':'4493893.745713'}]}
