...
def getAcademy(request):
	if request.user.is_active :
		...
		return {'branches': branches, 'academies' : academies, 'displayname' : displayname,'instituteid' : instituteid, 'age_range': range(5, 20), 'billing_range': range(1, 32), 'month_range': range(1, 13), 'maxvehicle_range': range(1, 10)}
